...
void HowToCreateAPatient()
{
  ...
  patient.GetAge().SetValue(58, TimeUnit::yr);
  patient.GetWeight().SetValue(180, MassUnit::lb);
  ...
  patient.GetHeartRateBaseline().SetValue(80, FrequencyUnit::Per_min);
  patient.GetRespirationRateBaseline().SetValue(27, FrequencyUnit::Per_min);
